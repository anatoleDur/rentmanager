                        ...
                        <form class="form-horizontal" method="post">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="seats" name="seats" placeholder="${nb_places}" required>
                                    </div>
                                </div>
                                <!--
                                <div class="form-group">
                            ...
                            <div class="box-footer">
                                <button type="submit" class="btn btn-info pull-right" id="boutonAjout">Ajouter</button>
                            </div>
                            <!-- /.box-footer -->
                        </form>
                    </div>
